...
EPICS_CONFIG_SITE_HOST_FILE = "configure/os/CONFIG_SITE.${EPICS_HOST_ARCH}.${EPICS_HOST_ARCH}"
...
EOF
    ...
    # The host-pass flag file embeds the build-host flags; it is build-time
    # only and must not ship.
    rm -f ${install_dir}/${EPICS_CONFIG_SITE_HOST_FILE}
